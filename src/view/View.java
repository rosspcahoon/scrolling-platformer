...
public class View extends JComponent {
    ...
    public void paintComponent (Graphics pen) {
        Image img =
                new ImageIcon(getClass().getResource("/images/forestbackground.jpg")).getImage();
        int horizontal =
                ((int) myGame.getRightBoundary() + this.getWidth() * 1000) % this.getWidth();
        int vertical =
                ((int) myGame.getLowerBoundary() + this.getHeight() * 100) % this.getHeight();
        ...
        pen.drawImage(img, this.getWidth() - horizontal, this.getHeight() - vertical, 800, 300,
                      null);
